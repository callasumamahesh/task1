...
function BuyNow() {
    ...
    return (
        <div>
            <h1 className='text-center mt-[1rem] font-bold mt-[1rem] md:mt-[10px]'>Steps To Buy A Product</h1>
                        ...
                        <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
                            ...
                            <div className="flex relative">
                                ...
                                <div className="flex-grow pl-4">
                                    ...
                                    <p className="leading-relaxed">You will get your product on this date.</p>
                                </div>
                            </div>
                        </div>
                        {
